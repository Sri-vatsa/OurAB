...
public abstract class AddressBookSystemTest {
    ...
    protected void assertSelectedCardChanged(Index expectedSelectedCardIndex) {
        String[] selectedCardName = getPersonListPanel().getHandleToSelectedCard().getName().split(" ");
        URL expectedUrl;
        try {
            expectedUrl = new URL(LINKEDIN_SEARCH_URL_PREFIX + LINKEDIN_SEARCH_PEOPLE + LINKEDIN_SEARCH_PARAM_LOCATION + LINKEDIN_SEARCH_PARAM_FIRST_NAME +
                    selectedCardName[0] + LINKEDIN_SEARCH_PARAM_LAST_NAME + selectedCardName[1] + LINKEDIN_URL_SUFFIX);
